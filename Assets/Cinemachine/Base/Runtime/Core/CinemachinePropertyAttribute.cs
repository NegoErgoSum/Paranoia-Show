...
namespace Cinemachine
{
    ...
    public sealed class DocumentationSortingAttribute : System.Attribute
    {
        ...
        public enum Level 
        { 
            /// <summary>NpcType is excluded from documentation</summary>
            Undoc, 
            /// <summary>NpcType is documented in the API reference</summary>
            API, 
            /// <summary>NpcType is documented in the highly-refined User Manual</summary>
            UserRef 
        };
